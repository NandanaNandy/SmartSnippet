...
// Dummy function to extract code (this should be implemented in content.js)
function extractCode() {
    const codeBlocks = document.querySelectorAll("table.highlight tbody tr");
    let extractedCode = "";

    codeBlocks.forEach(row => {
        const codeLine = row.querySelector("td.blob-code");
        if (codeLine) {
            extractedCode += codeLine.innerText + "\n";
        }
    });
...
// chrome.runtime.onInstalled.addListener(() => {
//     console.log("SmartSnippet Extension Installed.");
//     console.log("Code Explain Icon Extension Installed");
// });
